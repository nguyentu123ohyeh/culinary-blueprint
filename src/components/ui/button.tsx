  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold uppercase tracking-wider ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-foreground/20 bg-transparent hover:bg-foreground/5 hover:border-foreground/40 rounded",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded",
        ghost: "hover:bg-foreground/5 rounded",
        link: "text-foreground underline-offset-4 hover:underline",
        brass: "bg-brass-gradient text-brass-foreground hover:shadow-brass hover:-translate-y-0.5 rounded",
        hero: "bg-brass-gradient text-brass-foreground text-base px-8 py-4 hover:shadow-brass hover:-translate-y-0.5 rounded",
        technical: "border border-foreground bg-transparent text-foreground hover:bg-foreground hover:text-background font-mono text-xs rounded",
      },
      size: {
